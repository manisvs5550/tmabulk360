...
<div class="page-content">
    <div class="inv-wrapper">
        <div class="inv-header">
            <h1><i class="fa-solid fa-clipboard-list"></i> Tools for Cleaning &amp; Maintenance</h1>
            ...
            <form method="POST" action="inventory_submit.php">
                    ...
                    <table class="inv-table">
                        <thead>
                            <tr>
                                ...
                                <th class="col-min">Min Required</th>
                                <th class="col-rob">ROB Qty</th>
                ...
                <div class="inv-actions">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fa-solid fa-paper-plane"></i> Submit Inventory
                    </button>
                </div>
            </form>
        </div>
